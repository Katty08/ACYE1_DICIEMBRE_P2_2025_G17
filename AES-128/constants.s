.section .data
    ...
    .global key_err_msg
    .global newline
    .global msg_inverse_title
    .global msg_round_key
    .global msg_colon
    .global msg_original_key
    .global msg_ciphertext
    .global msg_cipher_state
    .global msg_plain_title
    .global msg_state_title
    .global msg_round_hdr
    .global msg_after_isr
    .global msg_after_isb
    .global msg_after_ark
    .global msg_after_imc
...
.section .bss
    ...
    // === DEFINICIONES ===
    lastKey: .space 16
    expandedKeys: .space 176
    buffer: .space 256
    tempWord: .space 4
    cipherState: .space 16
